...
export const es = {
  ...
  auth: {
    ...
    cardDescription:
      "Solo personal autorizado con credenciales de empresa del backend.",
    tabs: { signIn: "Iniciar sesión", signUp: "" },
    emailLabel: "Email",
...
export const en: Dictionary = {
  ...
  auth: {
    ...
    cardDescription:
      "Authorized personnel only with backend company credentials.",
    tabs: { signIn: "Sign in", signUp: "" },
    emailLabel: "Email",
